...
namespace Business.Abstract
{
    public interface ISubcategoryService
    {
        ...
        Task<IDataResult<SubcategoryCreateDto>> AddSubcategoryAsync(SubcategoryCreateDto subcategoryCreateDto);
        Task<IResult> DeleteSubcategoryAsync(int id);
        Task<IResult> UpdateSubcategoryAsync(SubcategoryUpdateDto subcategoryUpdateDto);
    }
}
